...
public class StatisticsController{
	...
	/*@PutMapping
	@ApiOperation(value="Actualizar una estadistica")
	public ResponseEntity<Statistics> actualizar(@RequestBody Statistics entity){
		
		try {
			boolean flag = statisticsService.actualizar(entity);
			if(flag) {
				return new ResponseEntity<Statistics>(HttpStatus.OK);
			}else{
				return new ResponseEntity<Statistics>(HttpStatus.NOT_FOUND);
